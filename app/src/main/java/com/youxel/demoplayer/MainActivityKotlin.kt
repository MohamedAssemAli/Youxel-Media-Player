...
class MainActivityKotlin : AppCompatActivity(), AndExoPlayerListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        andExoPlayerView.loadArtWork(R.drawable.ic_media_audio)
        findViewById<AppCompatButton>(R.id.local).setOnClickListener(
            this
        )
        ...
        // starter stream
        loadMP3Stream(PublicValues.TEST_URL_MP3)
    ...
    private fun loadMP3Stream(urlMP4: String) {
        andExoPlayerView.setSource(urlMP4)
    }
